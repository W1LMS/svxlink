...
apt-get install cmake g++ libasound2-dev libcurl4-gnutls-dev libgcrypt20-dev libgsm1-dev libpopt-dev libsigc++-2.0-dev tcl-dev libdbus-1-dev libcurl4-gnutls-dev
